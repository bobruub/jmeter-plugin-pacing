...
public class RedisSamplerGuiWrite extends AbstractSamplerGui {
  ...
  private final JTextField redisWriteData = new JTextField();

  private String redisType;

  public RedisSamplerGuiWrite() {
  ...
  private JPanel createRedisSamplerPanel(){
    ...
    JLabel redisWriteDataLabel = new JLabel("Data to write");
    ...
    layout.setHorizontalGroup(
        layout.createParallelGroup(Alignment.LEADING)
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(redisWriteDataLabel)
                .addPreferredGap(ComponentPlacement.RELATED)
                .addComponent(redisWriteData))
                );
        ...
        layout.createSequentialGroup()
            ...
            .addGroup(layout.createParallelGroup(Alignment.LEADING)
                ...
                .addComponent(redisSet, GroupLayout.PREFERRED_SIZE, 
                   GroupLayout.PREFERRED_SIZE,GroupLayout.PREFERRED_SIZE))
                   .addGroup(layout.createParallelGroup(Alignment.LEADING)
                .addComponent(redisWriteDataLabel, GroupLayout.PREFERRED_SIZE,
                    GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
                .addComponent(redisWriteData, GroupLayout.PREFERRED_SIZE, 
                   GroupLayout.PREFERRED_SIZE,GroupLayout.PREFERRED_SIZE))
                   );
  ...
  public void modifyTestElement(TestElement element) {
    ...
    if (element instanceof RedisSampler) {
      ...
      redisSampler.setRedisWriteData(redisWriteData.getText());
      redisSampler.setRedisType("WRITE");
    }
  }
  ...
  public void configure(TestElement element) {
    ...
    if (element instanceof RedisSampler) {
      ...
      redisWriteData.setText(redisSampler.getRedisWriteData());
