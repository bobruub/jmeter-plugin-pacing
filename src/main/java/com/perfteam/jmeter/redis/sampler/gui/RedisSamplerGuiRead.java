...
public class RedisSamplerGuiRead extends AbstractSamplerGui {
  ...
  private final JTextField redisReadMethod = new JTextField();
  private final JCheckBox keepData = new JCheckBox("Keep Data", true);


  private String redisType;

  public RedisSamplerGuiRead() {
  ...
  private JPanel createRedisSamplerPanel(){
    ...
    JLabel redisReadMethodLabel = new JLabel("Read method");
...
//                .addComponent(redisReadMethod))
  ...
  public void modifyTestElement(TestElement element) {
    ...
    if (element instanceof RedisSampler) {
      ...
      redisSampler.setRedisReadMethod(redisReadMethod.getText());
      redisSampler.setRedisType("READ");
  ...
  public void configure(TestElement element) {
    ...
    if (element instanceof RedisSampler) {
      ...
      redisReadMethod.setText(redisSampler.getRedisReadMethod());
