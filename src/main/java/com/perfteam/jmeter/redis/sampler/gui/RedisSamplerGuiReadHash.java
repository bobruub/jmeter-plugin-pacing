...
public class RedisSamplerGuiReadHash extends AbstractSamplerGui {
  ...
  public RedisSamplerGuiReadHash() {
...
//                .addComponent(redisReadMethod))
  ...
  public void modifyTestElement(TestElement element) {
    ...
    if (element instanceof RedisSampler) {
      ...
      redisSampler.setRedisType("READHASH");
